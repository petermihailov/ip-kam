  ...
  <Fragment>
    ...
    <Container>
      ...
      <Typography paragraph>
        Оплата заказов производится при получении товара. Возможна как наличная,
        так и безналичная оплата. Вы оплачиваете заказ, только когда он
        оказывается у вас на пороге.
      </Typography>
      ...
      <Typography paragraph>
        ...
        возможна уже на следующий день. В отдельных случаях возможна доставка в
        день заказа. Работаем Пн-Пт c 9:00 до 18:00, Cб-Вс с 10:00 до 17:00.
      </Typography>
      <Typography paragraph>
