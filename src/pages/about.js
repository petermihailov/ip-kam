  ...
  <Fragment>
    ...
    <Container>
      <Typography paragraph>
        Наша команда работает с 2012 года. Мы занимаемся установкой современных
        IP-систем видеонаблюдения, реализующих охранные функции и возможности
        самостоятельного контроля своего бизнеса или частной собственности за
        разумные деньги.
      </Typography>
      <Typography paragraph>
      ...
      <Typography paragraph>
        Каждый проект проходит 5 стадий контроля качества, сопровождается личным
        менеджером, а все расчёты проводятся персональным инженером проекта
      </Typography>
      <Typography>
        ...
        постгарантийная техническая поддержка на всём протяжении эксплуатации
        видеотехники. В цену комплекта оборудования входит стоимость работ и
